...
function moreAboutKaren(parents, noOfSiblings, isNuclearFamily) {
    let moreAboutKaren = { pa: parents, nos: noOfSiblings, inf: isNuclearFamily }
        // alert(typeof moreAboutKaren.nuclear)
    if (typeof moreAboutKaren.pa === typeof "" && typeof moreAboutKaren.nos === 'number' && typeof moreAboutKaren.inf === 'boolean')
        return true
    else
        return false
}
